...
products[0] = new Product("ABC", "Baker Brand Logo Deck-8.0 Black/Blue Skateboard Deck by Baker",  69.98);
products[1] = new Product("123", "Real Renewal Skateboard Deck",    39.95);
...
products[5] = new Product("D", "Plan B Pudwill OG Skateboard Deck",    49.95);
products[6] = new Product("E", "Almost Wordmark Red 8.0 skate deck",    44.95);
products[7] = new Product("F", "Superior Floral 8.0 Skateboard Deck",    34.95);

products[8] = new Product("G", "Flow Viper Snowboard",    194.97);
products[9] = new Product("H", "Superior Floral 8.0 Skateboard Deck",    34.95);
products[10] = new Product("I", "Roxy Radiance C2 BTX Snowboard",    344.96);
products[11] = new Product("J", "Burton Feather Snowboard",    265.96);
products[12] = new Product("K", "Rome Mod Rocker Reverse Camber Snowboard",    395.93);

products[13] = new Product("L", "Lost Stealth Rapidfire RF Surfboard by Firewire",    99.99);
products[14] = new Product("M", "PigDog Surfboard",    324.96);
products[15] = new Product("N", "Sumo Surfboard",    550.00);
products[16] = new Product("O", "Ronjon",    34.95);
products[17] = new Product("P","Cabo Soft Surfboard",    329.95);
...
var free_shipping_quota = 0.00;     // applied if free_shipping_allowed, set to 0.00 for always free
